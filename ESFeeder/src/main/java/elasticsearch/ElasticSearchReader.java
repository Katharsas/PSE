...
public class ElasticSearchReader extends ElasticSearchController
    ...
    /**
     * @return a list with Article from the db needs the name and type of the created index needs a string from one of the analyzed properties (fields) as searchquery needs an integer or date object from one of the properties (fields) as range
     *
    ...
    public ArrayList<Article> getSimilair(ArticleId articleId, int skip, int limit) {
        ...
        ArrayList<Article> resultList; //vll spaeter kreieren mit der groesse der Hitlist // Remark by dbeckstein : please don't use Umlaute !
